...
import { getMouseWheelDistance, } from 'quasar/src/utils/event.js';
import { setScrollPosition, setHorizontalScrollPosition, } from 'quasar/src/utils/scroll.js';
...
import TouchPan from 'quasar/src/directives/TouchPan.js';
...
export default {
  ...
  render ( h ) {
    ...
    return h( 'div', {
      ...
      h( 'div', {
        ref: 'target',
        staticClass: 'scroll relative-position overflow-hidden fit flex flex-center',
        on: {
