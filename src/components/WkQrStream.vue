...
<script>
import { keepScanning, } from 'vue-qrcode-reader/src/misc/scanner.js';
import { thinSquare, } from 'vue-qrcode-reader/src/misc/track-func.js';
import Camera from 'vue-qrcode-reader/src/misc/camera.js';
